...
from help_func import get_full_path

# ==== Constants ====
is_test = False
FOLDER_PATH = "t" if is_test else "media"
OUTPUT_VIDEO = "t.mp4" if is_test else "video_output.mp4"
FPS_SINGLE = 2  # Normal FPS (1 frame = 0.5 seconds per image)
MAX_WIDTH = 1920
MAX_HEIGHT = 1080
ENCODE_FORMAT = "mp4v"
NUM_THREADS = 6
